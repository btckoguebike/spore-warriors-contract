...
pub enum SystemId {
    ...
    InstantDefenseDown,
    InstantAttackWeakUp,
    InstantAttackWeakDown,
    InstantDefenseWeakUp,
    InstantDefenseWeakDown,
    InstantMaxHpUp,
    InstantMaxHpDown,
    InstantDrawCards,
...
impl TryFrom<u16> for SystemId {
    ...
    fn try_from(value: u16) -> Result<Self, Self::Error> {
        match value {
            ...
            9 => Ok(Self::InstantAttackUp),
            10 => Ok(Self::InstantAttackDown),
            11 => Ok(Self::InstantDefenseUp),
            12 => Ok(Self::InstantDefenseDown),
            13 => Ok(Self::InstantAttackWeakUp),
            14 => Ok(Self::InstantAttackWeakDown),
            15 => Ok(Self::InstantDefenseWeakUp),
            16 => Ok(Self::InstantDefenseWeakDown),
            17 => Ok(Self::InstantMaxHpUp),
            18 => Ok(Self::InstantMaxHpDown),
